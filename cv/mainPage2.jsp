		...
		<html>
			<head>
				...
				<meta name="viewport" content="width=device-width, initial-scale=1.0">
					...
					<link rel="stylesheet" media="print" href="assets/style2.css" />
	...
	<body>
		...
		<form type="POST" action="submit.jsp" target="_blank">
			...
			<fieldset>
			 ...
			 <br>
			 <div class="imagesNextTo">
			 <div class="first" style="max-width: 200px" >
			 <img src="images/europass.png" style="max-width:100%;" />
			 </div>
